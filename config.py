...
tilesRules = { #[NORTH-EAST, SOUTH-EAST, SOUTH-WEST, NORTH-WEST]
    ...
    TILE_WATER_MIDDLE: {
        NORTH_EAST: [TILE_WATER_LEFT, TILE_WATER_RIGHT, TILE_WATER_EXTERNAL_MIDDLE],
        SOUTH_EAST: [TILE_DARK_GRASS_DIRT, TILE_DARK_GRASS_ROCK, TILE_DIRT_FULL, TILE_WATER_LEFT],
        SOUTH_WEST: [TILE_DARK_GRASS_DIRT, TILE_DARK_GRASS_ROCK, TILE_DIRT_FULL, TILE_WATER_RIGHT],
        NORTH_WEST: [TILE_WATER_LEFT, TILE_WATER_RIGHT, TILE_WATER_EXTERNAL_MIDDLE]
    }
}
...
tilesWeights = {
    TILE_DARK_GRASS_DIRT : 16,
    TILE_DARK_GRASS_ROCK : 16,
    TILE_DIRT_FULL : 4,
